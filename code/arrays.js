...
stationsLength = stations.push("London Kings Cross");
...
stations.splice(4,1); //(index start removing, how many)
 ...
 */
 ...
 stations.splice(3,0,"Darlington"); //(index start adding, delete? 0, what want to add)  //inserts at index 3 
...
const stoppingAtDurham = stations.find(element => element == "Durham" );

console.log("Did we find a Durham stop: ", stoppingAtDurham);
